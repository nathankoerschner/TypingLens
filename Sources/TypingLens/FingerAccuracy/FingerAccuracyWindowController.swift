...
final class FingerAccuracyWindowController: NSWindowController, NSWindowDelegate {
    ...
    func show() {
        ...
        let rootView = FingerAccuracyRootView(onClose: { [weak self] in
            self?.closeWindow()
        })
